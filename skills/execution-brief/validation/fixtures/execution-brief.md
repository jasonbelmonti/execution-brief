...
Deliver the verified execution brief and make it immediately usable for handoff. Keep this outcome-oriented and
...
- Validate this brief:
  `"${MARKDOWN_ENGINE_BIN_DIR:-$HOME/.local/bin}/markdown-engine" validate --file ./.codex/execution-briefs/EB-0001/execution-brief.md --profile <skill-dir>/profiles/execution-brief.yaml --format json`
